...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (a11yBtn) {
    ...
    if (localStorage.getItem('a11y-mode') === 'true') {
      ...
      document.body.classList.add('a11y-mode'); // also target body for body.a11y-mode CSS rules
    }

    // 2. Toggle on click
    a11yBtn.addEventListener('click', function () {
      document.documentElement.classList.toggle('a11y-mode');
      document.body.classList.toggle('a11y-mode'); // also target body for body.a11y-mode CSS rules
